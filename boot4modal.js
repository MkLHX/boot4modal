...
let modalTemplate = {
    dialog: '<div id="boot4modal" class="modal fade">' +
    ...
    closeButton: '<button class="close" style="margin-top: -15px;"  data-dismiss="modal">' +
        "<span>&times;</span>" +
        "</button>",
    button: '<button class="btn btn-info boot4ok" data-dismiss="modal" type="button">Close</button>',
    buttonConfirm: '<button class="btn btn-light boot4cancel" data-dismiss="modal" type="button">Cancel</button>' +
